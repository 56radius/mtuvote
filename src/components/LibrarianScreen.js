...
function LibrarianScreen() {
  ...
  const proCandidates = candidates.filter((candidate) => candidate.post === 7);

  const handleVote = (candidateId) => {
    if (candidateId && token) {
      axios
        .post(
          `https://nacos-vote.onrender.com/voters/vote/7/${candidateId}`, // Replace with your actual backend URL
          null,
          {
            headers: {
    ...
    <div>
      ...
      <main id="main" className="main">
        <div className="pagetitle">
          <h1>
            <span style={{ color: "green" }}>Pick your Librarian</span>
          </h1>
        </div>
